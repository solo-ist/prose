...
- **Next / now spinning up: Wave 1 — Core Build-Out** — three concurrent tracks on the **A→B→C merge ladder**. **Track C (Paid Platform, [#598](https://github.com/solo-ist/prose/issues/598)) is the first to move — Phase 0 now Do First:** the stack was selected 2026-06-15 and infra locked 2026-06-30 (Hono + Postgres + **Prisma 7** monolith on **Render**, DNS on **Hover**; Cloudflare = **R2** blobs only · **Better Auth** self-hostable · no-CRDT comment sync; planning doc [`architecture/web-platform.md`](architecture/web-platform.md)). The epic decomposed into **three discovery spikes** ([#601](https://github.com/solo-ist/prose/issues/601) auth/CSRF · [#775](https://github.com/solo-ist/prose/issues/775) SSE-through-Hono · [#776](https://github.com/solo-ist/prose/issues/776) comment-sync design) plus **seven build phases** ([#765–#771](https://github.com/solo-ist/prose/issues/765)). **#601 resolved** (Better Auth), **#775 proven** (SSE-through-Hono, 15/15) — so **[#765](https://github.com/solo-ist/prose/issues/765) Phase 0 is now Do First**; #776 + #766–#771 queued. #602 resolved (at-cost + entitlements); #258 folded in. Epic now **12 sub-issues** (deferred #439 + resolved #602 attached for traceability). Track B stays scope-gated by [#616](https://github.com/solo-ist/prose/issues/616) (closeout recommendation posted, pending ratification).
...
- **Column = phase, milestone = wave:**
  | Column | Phase |
  |---|---|
  | **Do First** + **Quick Wins** | priority/bigger vs. small — the v1.6.5 desktop batch shipped; **Do First** now leads with **Track C Phase 0 ([#765](https://github.com/solo-ist/prose/issues/765) gateway scaffold)** — #601 resolved + #775 proven — plus the remaining spike #776 and #487 (MAS provisioning), **Quick Wins** holds the v1.6.5 follow-ups (#790/#798/#801) alongside #536/#384 |
...
**Track C — Paid Platform Foundation** ([#598](https://github.com/solo-ist/prose/issues/598)) — *stack selected 2026-06-15, infra locked 2026-06-30; decomposed into native sub-issues (**12**: 3 spikes + 7 phases + attached #439/#602). #601 resolved + #775 proven → **[#765](https://github.com/solo-ist/prose/issues/765) Phase 0 is now Do First**; #776 + #766–#771 are Do Next.* **Stack:** Hono + Postgres (**Prisma 7**) monolith on **Render** · DNS on **Hover** (Render-managed TLS) · Cloudflare **R2** for blobs only (docs live in Postgres) · **Better Auth** (self-hostable) · no-CRDT comment sync. **Planning doc:** [`architecture/web-platform.md`](architecture/web-platform.md). Critical path: #765 → #766 → #767 → #768 → #769, with #770 parallel off #766 and #771 cross-cutting.
| Issue | Captures |
|---|---|
...
| [#598](https://github.com/solo-ist/prose/issues/598) Paid Platform Foundation | Track C / Wave 1 — **active (Phase 0 Do First)** | Wave 1 | #601 resolved + #775 proven; #765 (Do First) + #766–#771; spike #776; #364; #258 folded; attached children #439 (hosted-OCR) + #602 (billing, resolved) — **12 sub-issues, 2 done** |
