...
**Status:** Active · **Updated:** 2026-06-14 · **Live priority:** [Project board #5](https://github.com/orgs/solo-ist/projects/5/views/1)
...
- **Column = phase, milestone = wave:**
  | Column | Phase |
  |---|---|
  | **Do First** + **Quick Wins** | priority/bigger vs. small — Wave 0 is done; the next desktop batch (#699/#700/#703) leads Do First, and the Quick Wins tail is cleared (shipped in v1.6.4) |
  | **Do Next** | Wave 0.5's human (ASC) tail + Wave 1 Track C prep (spikes #601/#602/#603, epic #598, web exploration #258) |
