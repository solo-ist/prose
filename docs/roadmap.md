...
**Status:** Active · **Updated:** 2026-09-06 · **Live priority:** [Project board #5](https://github.com/orgs/solo-ist/projects/5/views/1)
...
- **[#487](https://github.com/solo-ist/prose/issues/487) is diagnosed** (2026-06-02): a provisioning gap, not a cert problem — the valid `Apple Development` cert is already under the MAS team (team = cert `OU`, not the CN parenthetical). The fix is regenerating `build/Prose_Development.provisionprofile` (+ confirming device registration) — a human Apple-account action. Local MAS QA stays broken until then; TestFlight remains the verification path. **Moved to On Hold** (2026-09-06) so Do First reflects actionable agent work; PR #778 (masDev identity pin) waits on the same human steps.
...
- **Shipped in v1.6.5** (2026-06-27 — desktop GitHub release + MAS **build 33** on TestFlight, VALID): the desktop QoL wave filed in the 2026-06-06 refinement, verified end-to-end via a full HITL QA loop. [#699](https://github.com/solo-ist/prose/issues/699) comment threading (replies + real resolved state + AI *Process*, folds #665) · [#700](https://github.com/solo-ist/prose/issues/700) extended-thinking blocks + dynamic streaming verbs (supersedes #556) · [#703](https://github.com/solo-ist/prose/issues/703) file-explorer interactivity (New Folder, folder rename, greyed non-md, dotfile toggle) · [#701](https://github.com/solo-ist/prose/issues/701) customizable toolbar/menus (wiggle edit mode) · [#722](https://github.com/solo-ist/prose/issues/722) per-mode Light/Dark themes · [#570](https://github.com/solo-ist/prose/issues/570) AI provenance for create/MCP/paste · the explorer-bug QA pass [#723](https://github.com/solo-ist/prose/issues/723) · and two data-loss fixes ([#727](https://github.com/solo-ist/prose/issues/727) stale-folder save, [#777](https://github.com/solo-ist/prose/issues/777) favorites crash). The QA loop itself caught **four real defects** a green build would have shipped (an a11y regression, a comment-store bug, a runtime-400 thinking param, a self-inflicted selector). Follow-ups filed (none blocking): #790 review cleanup · #797/#796 explorer multi-select/clipboard · #798/#799 footnotes · #800 provenance Tier 2 · #801 flaky e2e. **Remaining — human, in ASC:** submit v1.6.5 for review · the App Privacy label (optional Crash Data, not linked, per #391). **Earlier Quick Wins tail — cleared:** the build-32 batch (#704/#696/#686, via #718) shipped in the v1.6.3 GitHub release; #655/#664/#716/#717/#719 and #724 (footnotes)/#725/#728/#729 all shipped in **v1.6.4**.
- **Shipped in v1.7.0** (2026-07-03 — GitHub release): [#403](https://github.com/solo-ist/prose/issues/403) reMarkable **typed-text sync** (Type Folio documents extracted locally from the v6 `.rm` scene, no OCR needed; mixed notebooks resolve per page) via #807 — a Track B / reMarkable Parity item shipped ahead of its wave.
- **Shipped in v1.7.1** (2026-09-04 — **now the latest GitHub release**): the QoL point-release batch from the 2026-08-27 triage run, landed as 13 individually reviewed PRs on `release/v1.7.1` and verified in a full HITL QA loop (umbrella #855). Bugs: [#826](https://github.com/solo-ist/prose/issues/826) review-panel key hijacking (both panels) · [#827](https://github.com/solo-ist/prose/issues/827) ⌘F refocus · [#806](https://github.com/solo-ist/prose/issues/806) ⌘- zoom (incl. a macOS 26/Electron 40 key-equivalent workaround via focus-scoped hotkey) · [#798](https://github.com/solo-ist/prose/issues/798)/[#799](https://github.com/solo-ist/prose/issues/799) footnotes · [#830](https://github.com/solo-ist/prose/issues/830) comment-clobber data loss · [#829](https://github.com/solo-ist/prose/issues/829) stale session restore. Enhancements: [#832](https://github.com/solo-ist/prose/issues/832) AI-paste modal (+ QA-round fixes: layout, focus, block-gap caret crash = Sentry PROSE-Q) · [#797](https://github.com/solo-ist/prose/issues/797) explorer Duplicate (+ human-readable failure toasts) · [#792](https://github.com/solo-ist/prose/issues/792) bullet-marker preference (**default flipped to `*`**; task lists stay `- [ ]`). Riders: [#804](https://github.com/solo-ist/prose/issues/804) gray-matter removed · [#790](https://github.com/solo-ist/prose/issues/790) · [#801](https://github.com/solo-ist/prose/issues/801). The QA loop also grew a scope addition: the **watcher-less slice of [#843](https://github.com/solo-ist/prose/issues/843) external-edit detection** (focus-time staleness check, manual-save conflict dialog, autosave guard) — fs-watch immediacy remains open. Follow-ups filed: [#857](https://github.com/solo-ist/prose/issues/857) nested comment ranges · [#862](https://github.com/solo-ist/prose/issues/862) frontmatter date round-trip. Dependabot #819 closed in favor of a **dedicated dependency pass — 52 open alerts (25 high) need their own batch**. Also of note: first outside contribution **PR #854** (MCP collaborative review, 8.7k lines) assessed and held for restructuring — its design conversation belongs to [#831](https://github.com/solo-ist/prose/issues/831)/[#607](https://github.com/solo-ist/prose/issues/607). **Capture plan filed 2026-09-08** (maintainer-side restructure, contributor authorship preserved): umbrella #831 + the stack [#888](https://github.com/solo-ist/prose/issues/888) → [#889](https://github.com/solo-ist/prose/issues/889) → [#890](https://github.com/solo-ist/prose/issues/890) → [#891](https://github.com/solo-ist/prose/issues/891) — see the Track A section.
- **Shipped in v1.7.2** (2026-09-05 — security point release, **now the latest GitHub release**): the dedicated dependency pass promised above — **Electron 41** plus 51 of 52 Dependabot alerts cleared ([#865](https://github.com/solo-ist/prose/issues/865) via #867) — and the PROSE-P fatal-startup guard (unwritable-cwd `.dev.pid` write, [#869](https://github.com/solo-ist/prose/issues/869) via #870). The one surviving alert is [#866](https://github.com/solo-ist/prose/issues/866) **TipTap 2→3** — a full editor migration touching every custom extension and the annotation-persistence invariants, so it's scoped as its own project, never a batch rider. Follow-up filed: [#872](https://github.com/solo-ist/prose/issues/872) release.yml hardening (keychain-import retry + electron-builder draft-release race, both bitten during this release).
...
- **Active: the Web Epic ([#598](https://github.com/solo-ist/prose/issues/598)) — restructured 2026-09-06 into three sequential waves** (this ratifies the path the work already took; see the Wave 1 section below for the full tables). The plan: clear the security/QoL decks, then **W1 — commenting layer via HTML shared files** (mostly built: gateway scaffold PR #809 green with reviews addressed; the [#768](https://github.com/solo-ist/prose/issues/768) share-artifact layer built + HITL QA'd 2026-08-31 on `issue-768-share-service`) → **W2 — ATProto posting** (gated on spike [#850](https://github.com/solo-ist/prose/issues/850): BYO-identity vs hosted PDS) → **W3 — Prose web proper** (accounts [#766](https://github.com/solo-ist/prose/issues/766) · storage [#767](https://github.com/solo-ist/prose/issues/767) · live comment sync · paid tier [#770](https://github.com/solo-ist/prose/issues/770)/[#848](https://github.com/solo-ist/prose/issues/848)). All four discovery spikes are **resolved** (#601 Better Auth · #602 at-cost + entitlements · [#775](https://github.com/solo-ist/prose/issues/775) SSE proof via #808 · [#776](https://github.com/solo-ist/prose/issues/776) comment-layer design via #847); #258 folded in. **Consequence: the A→B→C merge ladder is retired as the operating model** — Tracks A (Smarter Desktop) and B (reMarkable parity, still scope-gated by [#616](https://github.com/solo-ist/prose/issues/616)) queue behind the web waves. Stack (unchanged, selected 2026-06-15): Hono + Postgres + Cloudflare R2 monolith · **Better Auth** self-hostable · no-CRDT comment sync; planning docs [`architecture/web-platform.md`](architecture/web-platform.md) + the #847 comment-layer design.
...
- **Column = phase, milestone = wave:**
  | Column | Phase |
  |---|---|
  | **Do First** | Web W1 landing work: #765 (merge PR #809) → the #768 share-service PR |
  | **Quick Wins** | small clear-the-decks items: #536/#384 stragglers + the v1.7.x follow-ups #856/#859/#862/#872 + #833 (process) + #888 (the PR #854 bug-fix extraction — ships ahead of its stack) |
  | **Do Next** | Web W1 hardening (#817 security remediation · #813 magic-link email) + the W2 gate spike (#850) + near-term bugs (#853 web-mode boot · #864 comment-count scoping) + #603 + W1-adjacent #857/#768/#769/#771 |
  | **Later** | Web W3 (#766/#767/#770/#848/#849) + Tracks A/B + their spikes + Project Mode (#697) + Knowledge Layer (#793/#794) + design/UX backlog (#698/#702) + gateway build-hygiene nits (#814/#816/#818) + parked-but-tracked (Annotations, #843 fs-watch remainder) |
  | **On Hold** | deferred: Wave 2, the #599-gated cluster (#706/#707/#708), #409, **#487** (blocked on human Apple steps, moved 2026-09-06), vision/research, launch gates |
...
- **Merge ladder — retired (2026-09-06):** the A→B→C concurrent-track ladder is no longer the operating model — the web epic leads as **three sequential waves** (W1 comments → W2 ATProto → W3 web proper), with Tracks A/B queued behind them. The gates survive the ladder: a **HITL QA gate at every wave boundary** (decide *cut a release tag* vs. *roll forward*; versions assigned at the moment of cut — the roadmap stays release-agnostic), and the **file-overlap pre-check** before any parallel agent dispatch.
- **Spikes gate the waves:** all four Track C discovery spikes are **resolved** ([#601](https://github.com/solo-ist/prose/issues/601) Better Auth · [#602](https://github.com/solo-ist/prose/issues/602) at-cost + entitlements · [#775](https://github.com/solo-ist/prose/issues/775) SSE proof · [#776](https://github.com/solo-ist/prose/issues/776) comment-layer design). [#850](https://github.com/solo-ist/prose/issues/850) (ATProto PDS) now gates **Web W2**; [#603](https://github.com/solo-ist/prose/issues/603) is a light confirmation; [#616](https://github.com/solo-ist/prose/issues/616) validates Track B's scope before building it.
...
| [#775](https://github.com/solo-ist/prose/issues/775) | Prove Anthropic **SSE streams through Hono** (`streamSSE`) — the gateway's LLM-proxy primitive. **Resolved 2026-06-16 → proven (15/15)**; proof + decision note landed via #808, seed branch consumed by the #765 scaffold (PR #809). Closed 2026-09-06. |
| [#776](https://github.com/solo-ist/prose/issues/776) | **Bidirectional comment-sync design** (modeled on `google/sync.ts`, no-CRDT). **Resolved 2026-08-27 → artifact model + ATProto direction** (design doc via #847). |
| [#850](https://github.com/solo-ist/prose/issues/850) | **ATProto PDS** — provision a PDS, validate a Standard.site record write; answers **BYO-identity vs hosted PDS**. Gates **Web W2** (ATProto posting). *(Do Next)* |
...
| [#487](https://github.com/solo-ist/prose/issues/487) | masDev local launch fails (Launchd 163) — restores local MAS QA. | diagnosed (provisioning gap); human Apple steps remain (**On Hold** 2026-09-06) |
...
### Wave 1 — Core Build-Out · *the Web Epic (Track C) leads as three sequential waves — restructured 2026-09-06; Tracks A/B queue behind it*
...
**Incoming via the PR #854 capture** (first outside contribution, by @shanelindsay; plan filed 2026-09-08 under umbrella [#831](https://github.com/solo-ist/prose/issues/831)): the 8.7k-line MCP-collaborative-review PR is being restructured maintainer-side into a stack, authorship preserved via cherry-pick/`Co-authored-by` — [#888](https://github.com/solo-ist/prose/issues/888) standalone bug fixes (**Quick Wins — ships ahead of the rest**) → [#889](https://github.com/solo-ist/prose/issues/889) ai-suggestions refactor as a mechanical move + explicit behavior fixes → [#890](https://github.com/solo-ist/prose/issues/890) MCP review lifecycle (10→19 tools) with a **human-decides gate** on `decide_suggestion` (the MVP answer to #607; ships #828) → [#891](https://github.com/solo-ist/prose/issues/891) Human Suggesting mode. #889–#891 are Track A work queued behind the web waves; PR #854 stays open as the reference until the stack supersedes it.
...
**Track C — Paid Platform Foundation / the Web Epic** ([#598](https://github.com/solo-ist/prose/issues/598)) — ***active, leads Wave 1.* Restructured 2026-09-06 from the phase ladder into three sequential waves** — sorted by value-per-infrastructure: the share/comment surface first (near-zero running cost, no accounts, every shared doc is marketing), distribution/identity second, and the accounts+storage+metering long pole (where the schedule risk lives) last. **Stack (unchanged):** Hono + Postgres + Cloudflare R2 monolith · **Better Auth** (self-hostable) · no-CRDT comment sync. **Planning docs:** [`architecture/web-platform.md`](architecture/web-platform.md) + the #847 comment-layer design (artifact model, ATProto direction). The old Phase 0–4 numbering survives inside the issues; the waves are the sequencing unit now. [#258](https://github.com/solo-ist/prose/issues/258) remains folded in (superseded).

**Web W1 — Commenting layer via HTML shared files** · *active — mostly built, landing now*
| Issue | Captures |
|---|---|
| [#765](https://github.com/solo-ist/prose/issues/765) | Phase 0 — gateway scaffold + deploy (Hono/PG/Drizzle/R2; integrates #601 auth + #775 SSE). **PR #809 green, reviews addressed — merge first.** |
| [#768](https://github.com/solo-ist/prose/issues/768) | Share artifact + embedded viewer + one-way comments. **Built + HITL QA'd 2026-08-31** on `issue-768-share-service` (share service 37/37 · ShareDialog publish · tier-3 offline annotate/download/re-import 16/16); PR opens after #809 merges. |
| [#769](https://github.com/solo-ist/prose/issues/769) *(offline slice)* | The identity-free comment flow ships here: one-way comments + download/annotate/re-import. The **live bidirectional sync slice is deferred to W3** — it needs accounts (#766) to know who a commenter is. |
| [#817](https://github.com/solo-ist/prose/issues/817) | Phase 0 gateway security remediation (rides the #809 merge). |
| [#813](https://github.com/solo-ist/prose/issues/813) | Real magic-link email delivery — gates opening signups. |
| [#857](https://github.com/solo-ist/prose/issues/857) | Nested/overlapping comment ranges — comment-*model* work, rides this wave rather than the QoL batch. |
| [#771](https://github.com/solo-ist/prose/issues/771) | MAS seams + `webPlatform` feature flag (cross-cutting, spans all three waves). |

**Web W2 — ATProto posting** · *gated on spike [#850](https://github.com/solo-ist/prose/issues/850)*
| Issue | Captures |
|---|---|
| [#850](https://github.com/solo-ist/prose/issues/850) | Spike: provision a PDS, validate a Standard.site record write. **Decides the wave's size**: BYO-identity (users bring their own handle/PDS — small) vs hosted PDS (drags W3-shaped infra forward — large). Build issues get filed from its conclusion. |

**Web W3 — Prose web proper** · *Later — deferred until W1–W2 ship*
| Issue | Captures |
|---|---|
...
| [#769](https://github.com/solo-ist/prose/issues/769) *(live slice)* | Bidirectional comment sync + resolution-to-history (consumes the #776 design; needs #766 accounts). |
| [#770](https://github.com/solo-ist/prose/issues/770) + [#848](https://github.com/solo-ist/prose/issues/848) | Phase 4 — entitlements + thin at-cost paid tier + soft monthly token quota. |
| [#849](https://github.com/solo-ist/prose/issues/849) | Pricing methodology + public cost-transparency page (co-op model). |
| [#853](https://github.com/solo-ist/prose/issues/853) | Web-mode boot broken at base — the W3 substrate (kept **Do Next** on the board as a bug). |
...
*Gateway build-hygiene follow-ups from the #809 review rounds sit in Later: [#814](https://github.com/solo-ist/prose/issues/814) bodyLimit + pinned models · [#816](https://github.com/solo-ist/prose/issues/816) test-gateway gated flow · [#818](https://github.com/solo-ist/prose/issues/818) Docker hardening (absorbed #815, closed as superseded).*
...
|---|---|---|---|
| [#596](https://github.com/solo-ist/prose/issues/596) A Smarter Desktop App | Track A / Wave 1 | Wave 1 | #604–#607; #314, #533, #260 (#556 → #700, shipped v1.6.5); the #854 capture stack (#831): #888–#891 |
| [#597](https://github.com/solo-ist/prose/issues/597) reMarkable App Parity | Track B / Wave 1 | Wave 1 | #608–#611; #403, #466 (scope via #616) |
| [#598](https://github.com/solo-ist/prose/issues/598) Paid Platform Foundation / Web Epic | Track C / Wave 1 — **active, leads** | Wave 1 | spikes resolved (#601/#602/#775/#776); **W1** #765/#768/#769-offline/#817/#813/#857/#771 · **W2** #850 · **W3** #766/#767/#769-live/#770/#848/#849/#853/#364; #258 folded; deferred child #439 |
...
- **MAS extras:** [#409](https://github.com/solo-ist/prose/issues/409) universal binary — formally parked 2026-06-06; revisit if Intel demand shows. [#487](https://github.com/solo-ist/prose/issues/487) masDev provisioning — parked 2026-09-06, blocked on human Apple-account steps (PR #778 ready behind them).
